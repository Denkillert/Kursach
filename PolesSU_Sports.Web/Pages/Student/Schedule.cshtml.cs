...
namespace PolesSU_Sports.Web.Pages.Student
{
    ...
    {
        public DataTable Schedule { get; set; } = new DataTable();  // ✅ Инициализация
        public string StudentName { get; set; } = "";  // ✅ Инициализация
        ...
        public IActionResult OnGet()
        {
            ...
            var scheduleData = DBConnection.Instance.ExecuteQuery(@"
                SELECT 
                    CASE sc.DayOfWeek
                ...
                JOIN Trainers t ON sec.TrainerID = t.DocumentNumber  -- ✅ Правильно
